...
public class JmsPublisherRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        ObjectMapper jmsMapper = new ObjectMapper();
        jmsMapper.registerModule(new JavaTimeModule());
        jmsMapper.disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
        jsonFormat.setObjectMapper(jmsMapper);
