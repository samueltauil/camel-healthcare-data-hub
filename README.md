...
Healthcare systems still rely heavily on flat files — CSV exports from EHRs, HL7v2 messages
over legacy interfaces, batch data drops to FTP servers. This project demonstrates how
[Apache Camel](https://camel.apache.org/) on [Quarkus](https://quarkus.io/) can act as a
**universal adapter layer**, polling those files and routing them to the protocols that
modern healthcare architectures demand.

**Inbound:** FTP polling with content-based routing (CSV, HL7v2, Synthea formats)<br>
**Outbound:** REST API · SOAP/WSDL · HL7 MLLP · FHIR R4 · JMS/ActiveMQ · Kafka<br>
**Data:** Realistic synthetic patients generated by [Synthea](https://github.com/synthetichealth/synthea)<br>
**Infra:** Fully containerized — one `docker-compose up` for FTP, Artemis, Kafka, HAPI FHIR, and Mirth Connect
